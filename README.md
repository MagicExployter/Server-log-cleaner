...
A simple bash script that deletes log files older than 14 days from standard Linux and ZimaOS paths, helping keep your server's disk usage under control.
